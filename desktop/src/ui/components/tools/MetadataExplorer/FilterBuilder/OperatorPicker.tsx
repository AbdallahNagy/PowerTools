...
export function OperatorPicker({ value, fieldType, onChange }: OperatorPickerProps) {
  ...
  return (
    <select
      ...
      disabled={!fieldType}
      className="w-36 shrink-0 bg-[#1e1e1e] border border-[#3c3c3c] rounded-sm px-2 py-1 text-sm text-[#cccccc] focus:outline-none focus:border-[#007fd4] disabled:opacity-40"
    >
