...
export function MutationImpactPreviewDialog({ title, environment, component, changes, warnings, blockers, confirmation, executing, confirmDisabled, onCancel, onConfirm }: {
  ...
  executing: boolean; confirmDisabled?: boolean; onCancel: () => void; onConfirm: () => void;
}) {
