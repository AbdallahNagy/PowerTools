...
it("shows workflow contract and dependent processes read-only, then updates only registration metadata", async () => {
  ...
  expect(details).toHaveTextContent("Properties");
